...
def load_myquantum_params():
    pd = dict()
    pd['data_dir'] = '/home/hanwen/Desktop/demo/NSCTA-Demo/local-embedding/data/quantum_cryptography/'
    pd['doc_file'] = pd['data_dir'] + 'input/papers.txt'
    pd['doc_keyword_cnt_file'] = pd['data_dir'] + 'input/keyword_cnt.txt'
    pd['input_dir'] = pd['data_dir'] + 'input/'
    pd['root_node_dir'] = pd['data_dir'] + 'cluster/'
...
def load_quantum_sensing_params():
    pd = dict()
    pd['data_dir'] = '/home/hanwen/Desktop/demo/NSCTA-Demo/local-embedding/data/quantum_sensing/'
    pd['doc_file'] = pd['data_dir'] + 'input/papers.txt'
    pd['doc_keyword_cnt_file'] = pd['data_dir'] + 'input/keyword_cnt.txt'
    pd['input_dir'] = pd['data_dir'] + 'input/'
    pd['root_node_dir'] = pd['data_dir'] + 'cluster/'
...
def load_test_params():
    pd = dict()
    pd['data_dir'] = '/home/hanwen/Desktop/demo/NSCTA-Demo/local-embedding/data/test/'
    pd['doc_file'] = pd['data_dir'] + 'input/papers.txt'
    pd['doc_keyword_cnt_file'] = pd['data_dir'] + 'input/keyword_cnt.txt'
    pd['input_dir'] = pd['data_dir'] + 'input/'
    pd['root_node_dir'] = pd['data_dir'] + 'cluster/'
