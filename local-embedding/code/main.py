...
if __name__ == '__main__':
    ...
    # opt = load_test_params()

    parser = argparse.ArgumentParser()
    parser.add_argument("--data_dir", nargs=1)
    # parser.add_argument("--doc_file", nargs=1)
    # parser.add_argument("--doc_keyword_cnt_file", nargs=1)
    # parser.add_argument("--input_dir", nargs=1)
    # parser.add_argument("--root_node_dir", nargs=1)
    parser.add_argument("--n_cluster", nargs=1, default=5)
    parser.add_argument("--filter_thre", nargs=1, default=0.15)
    parser.add_argument("--n_expand", nargs=1, default=100)
    parser.add_argument("--n_cluster_iter", nargs=1, default=2)
