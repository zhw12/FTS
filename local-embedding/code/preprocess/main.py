...
def main():
    ...
    # inputPath = "/Users/shenjiaming/Desktop/linked_results.wiki.pos.tsv"
    # outputPath = "/Users/shenjiaming/Desktop/keywords.txt"
    # inputPath = "/home/hanwen/Desktop/demo/NSCTA-Demo/local-embedding/AutoPhrase/quantum_cryptography/linked_results.wiki.pos.tsv"
    # outputPath = "/home/hanwen/Desktop/demo/NSCTA-Demo/local-embedding/AutoPhrase/quantum_cryptography/keywords.txt"
    ...
    dataset = "quantum_sensing"
    base_dir = "/home/hanwen/Desktop/demo/NSCTA-Demo/local-embedding"
    input_file_path = "/home/hanwen/Desktop/demo/NSCTA-Demo/concept_based_retrieval/output/quantum_sensing_expanded/segmentation.txt"
    output_file_path = "{baseDir}/AutoPhrase/{dataset}/papers.txt".format(baseDir=base_dir, dataset=dataset)
    ...
    # input_keyword_file_path = "/home/hanwen/Desktop/demo/NSCTA-Demo/concept_based_retrieval/AutoPhrase/SEMANTIC_SCHOLAR120w/AutoPhrase.txt"
    # output_keyword_file_path = "{baseDir}/AutoPhrase/{dataset}/keywords.txt".format(baseDir=base_dir, dataset=dataset)
    # threshold = 0.3
    # with open(input_keyword_file_path, "r") as fin, open(output_keyword_file_path, "w") as fout:
    #     for line in fin:
    #         score, keyword  = line.strip().split("\t")
    #         score = float(score)
    #         if score < threshold:
    #             break
    #         fout.write(keyword)
